...
// 	retry2 "github.com/tarampampam/tinifier/v4/internal/retry"
...
//
// 	var (
// 		tiny = tinypng.NewClient("", tinypng.WithHTTPClient(w.tinyHTTPClient))
// 		info *tinypng.Compressed
// 	)
//
// 	if err = retry2.Do(
// 		func(attemptNum uint) error {
// 			key, keyErr := w.keeper.Get()
// 			if keyErr != nil {
...
//
// 			compressCtx, cancelCompressing := context.WithTimeout(ctx, uploadTimeout)
// 			defer cancelCompressing()
//
// 			compResponse, uplErr := tiny.Compress(compressCtx, file)
// 			if uplErr != nil {
